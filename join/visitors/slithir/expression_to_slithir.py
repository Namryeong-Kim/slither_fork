...
from join.core import expressions
...
from join.core.declarations.variables.solidity_variables import SolidityVariable, SolidityFunction, SolidityVariableComposed
from join.core.expressions import (
    AssignmentOperation,
...
from join.core.expressions.binary_operation import BinaryOperation
...
from join.core.expressions.new import NewArray, NewContract
...
from join.slithir.tmp_operations.argument import Argument
...
from join.slithir.variables import (
    Constant,
    ReferenceVariable,
    TemporaryVariable,
    TupleVariable,
...
class ExpressionToSlithIR(ExpressionVisitor):
    ...
    def __init__(self, expression: Expression, node: "Node") -> None:
        from join.core.cfg.node import NodeType  # pylint: disable=import-outside-toplevel
