...
from join.core.declarations.function.function import Function, FunctionType, FunctionLanguage


from join.core.declarations.const.erc_const import (
    ERC20_signatures,
    ERC165_signatures,
    ERC223_signatures,
    ERC721_signatures,
...
if TYPE_CHECKING:
    from join.core.declarations.solidity_type.type_helpers import LibraryCallType, HighLevelCallType, InternalCallType
...
class Contract(SourceMapping):  # pylint: disable=too-many-public-methods
    ...
    def is_upgradeable_proxy(self) -> bool:
        ...
        from join.slithir.operations import LowLevelCall
    ...
    def is_incorrectly_constructed(self) -> bool:
        """
        Return true if there was an internal join's issue when analyzing the contract
        :return:
        """
    ...
    def convert_expression_to_slithir_ssa(self) -> None:
        ...
        :return:
        """
        from join.slithir.variables import StateIRVariable
