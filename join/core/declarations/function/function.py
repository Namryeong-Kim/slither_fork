...
from join.core.cfg.scope import Scope
from join.core.declarations.variables.solidity_variables import (
    SolidityFunction,
    SolidityVariable,
    SolidityVariableComposed,
)
from join.core.expressions.identifier import Identifier
from join.core.expressions.index_access import IndexAccess
from join.core.expressions.member_access import MemberAccess
from join.core.expressions.unary_operation import UnaryOperation
...
from join.core.declarations.solidity_type.convert_type import convert_type_for_solidity_signature_to_string
...
if TYPE_CHECKING:
    from join.core.declarations.solidity_type.type_helpers import (
        InternalCallType,
        LowLevelCallType,
        HighLevelCallType,
        LibraryCallType,
    ...
    from join.core.cfg.node import Node, NodeType
    from join.core.declarations.variables.variable import Variable
    from join.slithir.variables.variable import SlithIRVariable
    from join.slithir.variables import LocalIRVariable
...
class Function(SourceMapping, metaclass=ABCMeta):  # pylint: disable=too-many-public-methods
    ...
    def __init__(self, compilation_unit: "JoinCompilationUnit") -> None:
        ...
        self.compilation_unit: "JoinCompilationUnit" = compilation_unit
    ...
    def name(self) -> str:
        ...
        if self._function_type == FunctionType.CONSTRUCTOR_VARIABLES:
            return "JoinConstructorVariables"
        if self._function_type == FunctionType.CONSTRUCTOR_CONSTANT_VARIABLES:
            return "JoinConstructorConstantVariables"
        return self._name
    ...
    def can_reenter(self, callstack: Optional[List[Union["Function", "Variable"]]] = None) -> bool:
        ...
        :return bool:
        """
        from join.slithir.operations import Call
    ...
    def is_constructor_variables(self) -> bool:
        ...
        Join has inbuilt functions to hold the state variables initialization
        """
    ...
    def nodes_ordered_dominators(self) -> List["Node"]:
        ...
        # from join.core.cfg.node import NodeType
    ...
    def return_values(self) -> List["SlithIRVariable"]:
        ...
        """
        from join.core.cfg.node import NodeType
        from join.slithir.operations import Return
        from join.slithir.variables import Constant
    ...
    def _solidity_variable_in_binary(node: "Node") -> List[SolidityVariable]:
        from join.slithir.operations.binary import Binary
    ...
    def _solidity_variable_in_internal_calls(node: "Node") -> List[SolidityVariable]:
        from join.slithir.operations.internal_call import InternalCall
    ...
    def _get_last_ssa_variable_instances(
        ...
        from join.slithir.variables import ReferenceVariable
        from join.slithir.operations import OperationWithLValue
        from join.core.cfg.node import NodeType
    ...
    def _unchange_phi(ir: "Operation") -> bool:
        from join.slithir.operations import Phi, PhiCallback
    ...
    def fix_phi(
        ...
        from join.slithir.operations import InternalCall, PhiCallback
        from join.slithir.variables import Constant, StateIRVariable
