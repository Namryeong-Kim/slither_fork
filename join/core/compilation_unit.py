...
from join.slithir.operations import InternalCall
from join.slithir.variables import Constant

if TYPE_CHECKING:
    from join.core.core import JoinCore


# pylint: disable=too-many-instance-attributes,too-many-public-methods
class JoinCompilationUnit(Context):
    # region Init
    ###################################################################################
    ###################################################################################
    def __init__(self, core: "JoinCore", crytic_compilation_unit: CompilationUnit) -> None:
        super().__init__()
