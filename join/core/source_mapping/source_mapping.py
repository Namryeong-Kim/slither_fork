...
def _compute_line(
    compilation_unit: "JoinCompilationUnit", filename: Filename, start: int, length: int
...
def _convert_source_mapping(
    offset: str, compilation_unit: "JoinCompilationUnit"
...
class SourceMapping(Context, metaclass=ABCMeta):
    ...
    def set_offset(
        self, offset: Union["Source", str], compilation_unit: "JoinCompilationUnit"
    ) -> None:
    ...
    def add_reference_from_raw_source(
        self, offset: str, compilation_unit: "JoinCompilationUnit"
    ) -> None:
