...
from join.all_exceptions import JoinException
from join.core.expressions import UnaryOperation
from join.core.expressions.assignment_operation import AssignmentOperation
...
class SplitTernaryExpression:
    ...
    def copy_expression(
        ...
        if isinstance(expression, ConditionalExpression):
            raise JoinException("Nested ternary operator not handled")
