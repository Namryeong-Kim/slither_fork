...
from join.slithir.operations import Index, OperationWithLValue, InternalCall, Operation
from join.slithir.utils.utils import LVALUE
...
def compute_dependency(compilation_unit: "JoinCompilationUnit") -> None:
...
def compute_dependency_contract(
    contract: Contract, compilation_unit: "JoinCompilationUnit"
) -> None:
