...
import join.slithir.variables.tuple_ssa
...
from join.core.declarations.variables.solidity_variables import SolidityFunction, SolidityVariable
...
from join.slithir.operations.operation import Operation
...
def add_ssa_ir(
    ...
    all_state_variables_instances: Dict[
        str, join.slithir.variables.state_variable.StateIRVariable
    ],
) -> None:
    """
