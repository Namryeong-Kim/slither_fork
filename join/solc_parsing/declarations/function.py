...
from join.core.cfg.node import NodeType, link_nodes, insert_node, Node
from join.core.cfg.scope import Scope
from join.core.declarations.contract.contract import Contract
from join.core.declarations.function.function import Function, FunctionType, ModifierStatements
from join.core.declarations.function.function_contract import FunctionContract
from join.core.expressions import AssignmentOperation
from join.core.source_mapping.source_mapping import Source
...
from join.solc_parsing.cfg.node import NodeSolc
...
from join.solc_parsing.variables.local_variable import LocalVariableSolc
from join.solc_parsing.variables.local_variable_init_from_tuple import (
    LocalVariableInitFromTupleSolc,
)
from join.solc_parsing.variables.variable_declaration import MultipleVariablesDeclaration
from join.core.expressions.expression_manipulations import SplitTernaryExpression
from join.visitors.expression.export_values import ExportValues
from join.visitors.expression.has_conditional import HasConditional
from join.solc_parsing.yul.parse_yul import YulBlock
...
class FunctionSolc(CallerContextExpression):
    ...
    def __init__(
        ...
        self._join_parser: "JoinCompilationUnitSolc" = join_parser
    ...
    def _parse_try_catch(self, statement: Dict, node: NodeSolc) -> NodeSolc:
        ...
        if externalCall is None:
            raise ParsingError(f"Try/Catch not correctly parsed by Join {statement}")
        catch_scope = Scope(
            node.underlying_node.scope.is_checked, False, node.underlying_node.scope
        )
    ...
    def _parse_catch(self, statement: Dict, node: NodeSolc) -> NodeSolc:
        ...
        if block is None:
            raise ParsingError(f"Catch not correctly parsed by Join {statement}")
