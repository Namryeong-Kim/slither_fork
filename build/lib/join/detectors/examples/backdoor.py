...
from join.detectors.abstract_detector import (
    AbstractDetector,
    DetectorClassification,
    DETECTOR_INFO,
)
from join.print.output import Output
...
class Backdoor(AbstractDetector):
    ...
    ARGUMENT = "backdoor"  # join will launch the detector with join.py --mydetector
