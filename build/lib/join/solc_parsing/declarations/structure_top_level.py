...
from join.core.declarations.variables.structure_variable import StructureVariable
from join.solc_parsing.declarations.caller_context import CallerContextExpression
from join.solc_parsing.variables.structure_variable import StructureVariableSolc
...
class StructureTopLevelSolc(CallerContextExpression):  # pylint: disable=too-few-public-methods
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        if join_parser.is_compact_ast:
            name = struct["name"]
            attributes = struct
        else:
            name = struct["attributes"][join_parser.get_key()]
    ...
    def analyze(self) -> None:
        for elem_to_parse in self._elemsNotParsed:
            ...
            elem.set_offset(elem_to_parse["src"], self._join_parser.compilation_unit)
