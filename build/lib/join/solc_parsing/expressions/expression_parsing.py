...
import join.core.expressions.type_conversion
from join.core.declarations.variables.solidity_variables import SolidityVariableComposed, SOLIDITY_VARIABLES_COMPOSED
from join.core.expressions.call_expression import CallExpression
from join.core.expressions.elementary_type_name_expression import ElementaryTypeNameExpression
...
from join.core.expressions.new import NewArray, NewContract, NewElementaryType
from join.core.expressions.super import SuperCallExpression, SuperIdentifier
from join.core.expressions.tuple_expression import TupleExpression
from join.core.expressions.type_conversion import TypeConversion
from join.core.expressions.unary_operation import UnaryOperation, UnaryOperationType
from join.core.expressions.assignment_operation import (
    AssignmentOperation,
    AssignmentOperationType,
)
from join.core.expressions.binary_operation import (
    BinaryOperation,
    BinaryOperationType,
)
...
from join.solc_parsing.expressions.find_variable import find_variable
from join.solc_parsing.solidity_types.type_parsing import UnknownType, parse_type
...
def parse_call(
    ...
    join.core.expressions.call_expression.CallExpression,
    join.core.expressions.type_conversion.TypeConversion,
]:
    src = expression["src"]
