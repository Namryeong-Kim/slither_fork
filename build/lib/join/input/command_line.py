...
# from join.detectors.abstract_detector import classification_txt, AbstractDetector
# from join.printers.abstract_printer import AbstractPrinter
from join.utils.colors import yellow, red
...
def read_config_file(args: argparse.Namespace) -> None:
    ...
    if args.config_file is None:
        ...
        if os.path.exists("join.config.json"):
            # The default file exists, use it
            args.config_file = "join.config.json"
        else:
            return
