...
from join.core.core_exceptions import JoinCoreError
...
class UnaryOperationType(Enum):
    ...
    def get_type(operation_type: str, isprefix: bool) -> "UnaryOperationType":
        ...
        raise JoinCoreError(f"get_type: Unknown operation type {operation_type}")
    ...
    def __str__(self) -> str:
        ...
        raise JoinCoreError(f"str: Unknown operation type {self}")
    ...
    def is_prefix(operation_type: "UnaryOperationType") -> bool:
        ...
        raise JoinCoreError(f"is_prefix: Unknown operation type {operation_type}")
